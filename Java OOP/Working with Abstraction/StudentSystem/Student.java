...
public class Student {
    ...
    public String getStudentInfo() {
        ...
        if (grade >= 5.00) {
            ...
            studentInfo += " Very nice inheritanceExercise.interfacesAndAbstractionExercise.interfacesAndAbstractionExercise.Inheritance.person.interfacesAndAbstractionExercise.Inheritance.person.";
        }
        return studentInfo;
    }
}
